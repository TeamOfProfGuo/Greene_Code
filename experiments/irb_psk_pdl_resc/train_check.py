...
BASE_DIR = '.'
CONFIG_PATH = 'experiments/irb_psk_pdl_resc/results/config.yaml'
...
base_modules = [model.layer1, model.layer2, model.layer3, model.layer4,
                        model.d_layer1, model.d_layer2, model.d_layer3, model.d_layer4]
