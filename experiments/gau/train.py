...
parser.add_argument('--att_feat', type=str, default='rgb', help='which feature to use to compute attention')
parser.add_argument('--update_dep', action='store_true', default=False, help='whether to update dep in FuseModule')
parser.add_argument('--param', action='store_true', default=False, help='whether to add alpha param in AttModule')
