...
BASE_DIR = '.'
CONFIG_PATH = 'experiments/2stage/results/config.yaml'
...
parser.add_argument('--fuse_type', type=str, default='2stage', help='Attention type of multi-resolution fusion')
parser.add_argument('--mmf_att', type=str, default='CB_CA2a', help='Attention type to fuse rgb and dep')
parser.add_argument('--mode', type=str, default='late', help='process the feature map after first Att Module')
