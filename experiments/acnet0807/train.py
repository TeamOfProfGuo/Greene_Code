...
parser.add_argument('--lr', type=float, default=0.005, help='mrf fuse settings')
parser.add_argument('--scheduler', type=str, default='poly', help='mrf fuse settings')
...
class Trainer():
    def __init__(self, args):
        ...
        base_modules = [model.d_layer1, model.d_layer2, model.d_layer3, model.d_layer4,
                        model.m_layer1, model.m_layer2, model.m_layer3, model.m_layer4]
        base_ids = list(map(id, model.base.parameters())) + get_params(base_modules)
...
if __name__ == "__main__":
    ...
    args.lr = model_kwargs['lr']
    args.lr_scheduler = model_kwargs['scheduler']
    print('lr_scheduler {} lr{}'.format(args.lr, args.lr_scheduler))
