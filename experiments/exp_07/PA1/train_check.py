...
BASE_DIR = '.'
CONFIG_PATH = 'experiments/PA0/results/config.yaml'
...
parser.add_argument('--mrf_att', type=str, default='PA1', help='Attention type to fuse rgb and dep')
parser.add_argument('--mrf_act_fn', type=str, default='sigmoid', help='Attention type to fuse rgb and dep')
parser.add_argument('--mrf_conv', type=str, default=None, help='Attention type to fuse rgb and dep')
