...
BASE_DIR = '.'
CONFIG_PATH = 'experiments/ca2b_pdl/results/config.yaml'
...
#parser.add_argument('--mrfs', type=str, default='mrf=GF|att=pdl|gcfuse=merge-gc', help='mrf fuse settings')
parser.add_argument('--mrfs', type=str, default='mrf=GF|att=pdl|gcfuse=merge-gc&preBn-True|gcatt=descriptor-8&mfeats-16', help='mrf fuse settings')
