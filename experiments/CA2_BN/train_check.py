...
BASE_DIR = '.'
CONFIG_PATH = 'experiments/CA2b/results/config.yaml'
...
parser.add_argument('--bn', action='store_true', default=True, help='whether to apply BN in attention module')
parser.add_argument('--bn_dep', action='store_true', default=False, help='whether to update dep using BN')
parser.add_argument('--mmf_att', type=str, default='CA2b', help='Attention type to fuse rgb and dep')
